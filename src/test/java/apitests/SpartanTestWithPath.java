 ...
 */
    ...
    public void getAllSpartansWithPath(){
        ...
        //get last persons first  name
        String lastFirstName = response.path("name[-1]");
        System.out.println("Last persons first Name = " + lastFirstName);

        //get all first names and print out
        ...
        for(Object phones:phoneNums) {
          System.out.println("phone number :" + phones);

            //burada loop kullanmadik
          List<Integer> phone=response.path("phone");
            System.out.println("size() = " + phone.size());
            System.out.println("full list = " + phone);
        }
    }
}